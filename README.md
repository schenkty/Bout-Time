# Bout-Time
Treehouse Techdegree Project: Bout Time

Instuctions: 
You are free to submit this project in either Swift 2.3 or Swift 3. For Swift 2.3, if you are using Xcode 8, you will need to download and use the empty Swift 2.3 playground to start your project.
